...
const title = document.querySelector('.title');
    ...
    const paragraphs = [
        ...
        "最後最重要的，整個溫哥華被弗雷澤河包圍，要離開機場勢必得過河。所以暫訂計畫如下，我們下機後，趁夜色掩護，慢慢向西南角移動，那位置在機場和對岸中間有個淺灘，溪流深度也較淺，比較好橫渡。夢瑄我要你想辦法到對岸的西堤漫步小道和我們會合。”我向大家補充道。",
        ...
        "“我靠，為什麼你們的故事線這麼刺激？我也好想體驗一下啊！”夢瑄激動地喊道，眼裡閃爍著興奮的光芒。",
